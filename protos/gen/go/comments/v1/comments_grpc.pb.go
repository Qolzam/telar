...
const (
	CommentsService_GetRootCommentCount_FullMethodName = "/comments.v1.CommentsService/GetRootCommentCount"
)
...
type CommentsServiceClient interface {
	// Gets the count of root comments (non-reply comments) for a post.
	GetRootCommentCount(ctx context.Context, in *GetRootCommentCountRequest, opts ...grpc.CallOption) (*GetRootCommentCountResponse, error)
}
...
func (c *commentsServiceClient) GetRootCommentCount(ctx context.Context, in *GetRootCommentCountRequest, opts ...grpc.CallOption) (*GetRootCommentCountResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetRootCommentCountResponse)
	err := c.cc.Invoke(ctx, CommentsService_GetRootCommentCount_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CommentsServiceServer interface {
	// Gets the count of root comments (non-reply comments) for a post.
	GetRootCommentCount(context.Context, *GetRootCommentCountRequest) (*GetRootCommentCountResponse, error)
...
func (UnimplementedCommentsServiceServer) GetRootCommentCount(context.Context, *GetRootCommentCountRequest) (*GetRootCommentCountResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetRootCommentCount not implemented")
}
...
func _CommentsService_GetRootCommentCount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetRootCommentCountRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CommentsServiceServer).GetRootCommentCount(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CommentsService_GetRootCommentCount_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommentsServiceServer).GetRootCommentCount(ctx, req.(*GetRootCommentCountRequest))
	}
...
var CommentsService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetRootCommentCount",
			Handler:    _CommentsService_GetRootCommentCount_Handler,
		},
	},
