...
#
# Usage:
#   bash tools/dev/scripts/torture_test_20_steps.sh
#
# =============================================================================
...
curl -s -X POST http://localhost:8080/comments -H "Content-Type: application/json" -H "Authorization: Bearer $TOKEN_A" -d "{\"postId\":\"$POST_2_ID\",\"text\":\"Audit test comment $(date +%s)\"}" > /dev/null
sleep 2
